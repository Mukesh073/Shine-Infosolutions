...
class Anita_GL_Carousel {
  constructor(d, e = !1) {
    ...
    let b = new THREE.TextureLoader().load("img/ground.jpg"),
      c = { x: 16, y: 8 };
...
jQuery(".anita-gl-carousel-gallery").length &&
  jQuery.getScript("studio/js/lib/three.min.js").done(function () {
    jQuery.getScript("studio/js/lib/shaders/reflector.js").done(function () {
