...
const anita_config = {
  ...
  socials: {
    facebook: {
      url: "https://www.facebook.com/profile.php?id=61569279904628",
      label: "<i class='fa fab fa-facebook'></i>",
    },
    instagram: {
      url: "https://www.instagram.com/shine.studiogkp/",
      label: "<i class='fa fab fa-instagram'></i>",
    },
  },
  ...
  l10n: {
    ...
    copyright:
      "Copyright &copy; 2025. All Rights Reserved. <a href='https://www.shineinfosolutions.in/shine-studio.html'>Shine Studio</a>",
  ...
  init_page() {
    ...
    if (jQuery(".anita-gl-carousel-gallery").length) {
      if (typeof Anita_GL_Carousel !== "function") {
        jQuery.getScript("studio/js/anita-gl-carousel.js");
      }
    }
    ...
    if (jQuery(".anita-gl-roll-gallery").length) {
      if (typeof Anita_GL_Roll !== "function") {
        jQuery.getScript("studio/js/anita-gl-roll.js");
      }
    }
    ...
    if (jQuery(".anita-gl-slider-gallery").length) {
      if (typeof Anita_GL_Slider !== "function") {
        jQuery.getScript("studio/js/anita-gl-slider.js");
      }
    }
